...
MATERIALS!          Thermal Cond.    Density             Specific Heat            Q-Generation if applicable
    ...
    "Sample" : 				k=0.0398 	rho=0.5525				cp=536			! Argon  600 C	k=0.0398 	rho=0.5525				cp=536			! Argon  600 C
...
HISTORIES
   ...
   history(cylindrical_flux) as "Cylindrical Heat Rate (W)" export format "#t#r,#i" file="Argon600_CylindricalFlux.txt"  
   history((cylindrical_flux_all/AreaCylinderAll)/((top_flux_all+bottom_flux_all)/AreaTopBottomAll)) as "Ratio Radial to Axial Flux (W/mK)" export format "#t#r,#i" file="Argon600_Radial_to_Axial_Flux.txt"  
