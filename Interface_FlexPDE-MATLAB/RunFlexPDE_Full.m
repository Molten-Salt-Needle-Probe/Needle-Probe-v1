function FlexTvt = RunFlexPDE_Full(par_vector,par_names,SolvNam,endtime)
...
fprintf(fileID, 'temp_r2 = VAL(temp,%8.4f,0)\n', r_Ni);
fprintf(fileID, 'temp_r3 = VAL(temp,%8.4f,0)\n', r_samp);
...
%%%%%%%%% Obtain FlexPDE temp vs time profile %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
